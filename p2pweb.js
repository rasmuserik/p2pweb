 ...
 */
  ...
  HashAddress.generate = async (src /*ArrayBuffer | String*/) => {
  ...
  HashAddress.prototype.equals = function(addr) {
    for (let i = 0; i < 32; ++i) {
   ...
   */
  HashAddress.prototype.dist = function(addr) {
   ...
   */
  HashAddress.prototype.distBit = function(addr) {
   ...
   */
  HashAddress.distBit = function(dist) {
   ...
   */
  HashAddress.prototype.flipBitRandomise = function(pos) {
